...
# Using data from chapter 02 of Machine Learning in Action" chapter 02
##############################################################################
...
class GV:
    def __init__(self):
        self.samples = []        # Sample Data
        self.tests = []          # Tests Data
        self.models = []         # Training Data
        self.diff_dict = []      # cache the calculation of the difference between predicted y and true y
        self.cur_mno = 0         # current model
        self.cache_kernel = []   # cache the kernel function calculation result
        self.use_linear = False  # whether use linear kernel function calculation
        self.RBF_dlt = 10        # bandwith of Radial basis function kernel
...
##############################
# difference between preidction xi and real xi
##############################
...
##############################
# Optimized prediction difference
##############################
